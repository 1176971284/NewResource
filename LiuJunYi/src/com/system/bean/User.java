...
public class User {
    ...
    private int deptgroup;//` int(1) DEFAULT '0' COMMENT '部门大类：0市场部 、1基金销售、 2机构客户部、 3重庆代理1、4重庆代理2 、 5西安代理 、6南京代理1、 7南京代理2、8苏州代理、9泰州代理、10长春代理 、11太原代理',PRIMARY KEY (`userid`)

    public User(String username, String password, String email, String phone,int userid) {
