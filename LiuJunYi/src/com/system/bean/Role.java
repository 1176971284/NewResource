...
public class Role {
    ...
    public Role( String rolename, int deptid, String create_time,int roleid) {
    ...
    public Role(String rolename, int deptid, String create_time) {
        this.rolename = rolename;
        this.deptid = deptid;
        this.create_time = create_time;
    }

    public Role(int roleid, String rolename, int deptid, int dr, String create_time, int create_id, Timestamp update_time, int update_id) {
        this.roleid = roleid;
        this.rolename = rolename;
        this.deptid = deptid;
        this.dr = dr;
