...
public class Dept {
    ...
    public Dept(String deptname, String deptcode, String create_time) {
        this.deptname = deptname;
        this.deptcode = deptcode;
        this.create_time = create_time;
    }

    public Dept(String deptname, String deptcode, String create_time,int deptid) {
        this.deptname = deptname;
        this.deptcode = deptcode;
        this.create_time = create_time;
        this.deptid = deptid;
    ...
    public Dept(int deptid, int deptparaid, String deptname, String deptcode, int dr, String create_time, int create_id, Timestamp update_time, int update_id) {
        this.deptid = deptid;
